  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      if (searchUrl === "") {
        ...
        let searchWwithPage = searchUrl.replace('<pageNumber>', `${currentPage - 1}`);
        url = baseUrl + searchWwithPage;
      }
      ...
      setTotalPages(responseJson.page.totalElements);
        ...
        <div>
          ...
          {totalAmountOfBooks > 0 ? (
            <>
              ...
              <p>
                {indexOfFirstBook + 1} 0f {lastItem} of {totalAmountOfBooks}{" "}
                items:
              </p>
              {books.map((book) => (
